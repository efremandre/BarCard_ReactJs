...
const Cards = (props) => {
	...
	const preloader = props.loading ? <div className={style.loading}>Loading...</div>
		: null

	// eslint-disable-next-line react/prop-types
	const li = props.cards.map(el => (
			...
			<div className={style.card__item}>
				...
				<div className={style.card__description}>
					...
					<div className={style.card__buttons}>
						<button className={style.card__like} onClick={
							// eslint-disable-next-line react/prop-types
							() => props.like(el.idDrink)
						}>
		...
		<section className={style.barmenu}>
			...
			<div className="container">
				<ul className={style.cards}>
					{
						// eslint-disable-next-line react/prop-types
						props.isLikedArrayCardsEmpty ? <div className={style.emptyCards}>Favorites are empty</div> : li
					}
				</ul>
			</div>
		</section>
